...
class Augment:
    ...
    def __call__(self, x, metadata):
        if metadata is None:
            # For JUMP data or other datasets without otsuth metadata
            # Compute otsuth on-the-fly or use a default value
            th = None  # Let the crop_transform compute it automatically
