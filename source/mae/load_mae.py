...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_dir_mae',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir_mae',
...
def load_pretrained_mae(model_name, ckpt_path, remove_head=True, drop_path=0.1, global_pool=True ):    
